...
class HealthProfile(Base):
    ...
    family_member = db_relationship("FamilyMember", back_populates="health_profile", uselist=False)  # ✅ NEW RELATIONSHIP
...
class FamilyMember(Base):
    ...
    health_profile = db_relationship("HealthProfile", back_populates="family_member", uselist=False)  # ✅ NEW RELATIONSHIP
