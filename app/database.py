...
class User(Base):
    ...
    first_name = Column(String, nullable=False)  # ✅ FIX: Database has this as NOT NULL
    last_name = Column(String, nullable=False)   # ✅ FIX: Database has this as NOT NULL
    name = Column(String, nullable=True)          # Keep for backward compatibility
    zip_code = Column(String, nullable=True)      # ✅ FIX: ZIP CODE
