...
def run_migration():
    """Run database migration to add new health profile fields and fix password column"""
    print("🔧 Running database migration...")
    
    try:
        with engine.connect() as conn:
            # ==================== FIX 1: HASHED_PASSWORD COLUMN ====================
            print("🔐 Checking password column...")
            ...
            if not check_hashed:
                print("⚠️  hashed_password column missing! Fixing...")
                ...
                if check_password:
                    ...
                    if check_password_hash:
                        ...
                        print("📝 Creating new 'hashed_password' column...")
                        conn.execute(text("ALTER TABLE users ADD COLUMN hashed_password VARCHAR(255)"))
                        conn.commit()
                        print("✅ Created hashed_password column!")
            else:
            ...
            for query in migration_queries:
                try:
                    ...
                    print(f"⚠️  Migration query note: {e}")
