...
class User(Base):
    ...
    date_of_birth = Column(Date, nullable=True)    # ✅ Changed to Date type
    sex = Column(String, nullable=True)             # ✅ NEW: Gender/sex field
    gender = Column(String, nullable=True)          # ✅ NEW: Alternative gender field
    phone = Column(String, nullable=True)
    address = Column(Text, nullable=True)
    city = Column(String, nullable=True)            # ✅ NEW: City
    state = Column(String, nullable=True)           # ✅ NEW: State
    zip_code = Column(String, nullable=True)
    country = Column(String, nullable=True)         # ✅ NEW: Country
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if 'users' in inspector.get_table_names():
                ...
                nullable_columns = ['first_name', 'last_name', 'name', 'date_of_birth', 'sex', 'gender', 
