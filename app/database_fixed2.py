...
class HealthProfile(Base):
    ...
    family_member = db_relationship("FamilyMember", back_populates="health_profile", foreign_keys=[family_member_id], uselist=False)  # ✅ NEW RELATIONSHIP
...
class FamilyMember(Base):
    ...
    health_profile = db_relationship("HealthProfile", back_populates="family_member", foreign_keys=[health_profile_id], uselist=False)  # ✅ NEW RELATIONSHIP
