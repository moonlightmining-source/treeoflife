...
class Settings(BaseSettings):
    ...
    ALGORITHM: str = "HS256"
    JWT_ALGORITHM: str = "HS256"  # For JWT token creation
    ...
    def parse_allowed_origins(cls, v):
        """Parse ALLOWED_ORIGINS - accepts both string (comma-separated) and list"""
        if isinstance(v, str):
    ...
    def parse_upload_extensions(cls, v):
        """Parse ALLOWED_UPLOAD_EXTENSIONS - accepts both string (comma-separated) and list"""
        if isinstance(v, str):
