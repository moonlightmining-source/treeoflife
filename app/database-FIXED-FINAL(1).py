...
class HealthProfile(Base):
    ...
    family_member = relationship("FamilyMember", back_populates="health_profile", foreign_keys=[family_member_id], uselist=False)
...
class FamilyMember(Base):
    ...
    health_profile = relationship("HealthProfile", back_populates="family_member", foreign_keys=[health_profile_id], uselist=False)
