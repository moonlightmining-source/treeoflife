...
async def upload_lab_result(
    ...
    if media_type == "application/pdf":
        content_block = {"type": "document", "source": {"type": "base64", "media_type": media_type, "data": base64_content}}
    else:
        content_block = {"type": "image", "source": {"type": "base64", "media_type": media_type, "data": base64_content}}
    ...
    message = client.messages.create(
        ...
        messages=[{
            ...
            "content": [
                content_block,
                {"type": "text", "text": "Extract ALL lab test results. Return ONLY valid JSON."}
            ]
        }]
    )
