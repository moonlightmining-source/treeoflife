...
class Settings(BaseSettings):
    ...
    # CORS
    ALLOWED_ORIGINS: str = "http://localhost:3000,http://localhost:5173,https://tree-of-life-ai-frontend.vercel.app,https://tree-of-life-ai-frontend-roberts-projects-2d36ac41.vercel.app"
