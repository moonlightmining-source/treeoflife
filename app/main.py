...
def generate_conversation_title(text: str, max_length: int = 50) -> str:
    ...
    if last_space > 20:  # Make sure we have at least 20 chars
...
async def create_conversation(
    ...
    try:
        ...
        # Generate title and preview from initial message
        title = generate_conversation_title(data.initial_message)
        preview = generate_conversation_preview(data.initial_message)
