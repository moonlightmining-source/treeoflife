...
class FamilyMember(Base):
    ...
    gender = Column(String, nullable=True)
    notes = Column(Text, nullable=True)  # ✅ CHANGED from JSON to Text
    
    # Health profile link
    health_profile_id = Column(String, ForeignKey("health_profiles.id"), nullable=True)  # ✅ NEW FIELD
    ...
    health_profile = db_relationship("HealthProfile", back_populates="family_member", foreign_keys=[health_profile_id], uselist=False)  # ✅ Specify foreign key
