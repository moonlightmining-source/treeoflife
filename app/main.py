...
✅ LAB RESULTS FEATURE INTEGRATED - UUID FIX APPLIED
"""
...
from sqlalchemy.dialects.postgresql import UUID  # ✅ FIXED: Import UUID type
import shutil
import base64
import json
...
class LabResult(Base):
    ...
    user_id = Column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=False)  # ✅ FIXED: UUID type
    ...
    if test_connection():
        ...
        try:
            with engine.connect() as conn:
                ...
                # ✅ FIXED: Check lab_results table with UUID type
                result = conn.execute(text("""
